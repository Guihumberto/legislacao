<template>
    <v-form @submit.prevent="addUserElastic()" ref="form" class="form">
        ...
        <v-text-field
            ...
            density="compact"
            variant="outlined"
            :rules="[rules.required, rules.minfield, rules.cpfValido]"
        >
...
<script setup>
    ...
    const rules = {
        ...
        cpfValido: value => loginStore.validarCPF(value) || "CPF inválido"
    }
